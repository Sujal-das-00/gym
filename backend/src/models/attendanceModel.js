...
async function setMemberAttendance(memberId, date, present) {
  ...
  if (Boolean(before.length) !== Boolean(after.length)) await bumpAttendanceRevision();
}
...
async function attendanceStatusRows(date) {
